...
public class BeanRegistrationUtilTest {
  ...
  public void registerBeanDefinitionIfNotExistsWithoutBeanNameTest() {
    someRegistry.registerBeanDefinition(BeanDefinition.class.getName(),
        Mockito.mock(BeanDefinition.class));
    assertFalse(
        BeanRegistrationUtil.registerBeanDefinitionIfNotExists(someRegistry, BeanDefinition.class));
  }
  ...
  public void registerBeanDefinitionIfNotExistsWithoutBeanNameWithExtPropTest() {
    ...
    someRegistry.registerBeanDefinition(BeanDefinition.class.getName(),
        Mockito.mock(BeanDefinition.class));
    assertFalse(BeanRegistrationUtil.registerBeanDefinitionIfNotExists(someRegistry,
        BeanDefinition.class, extraPropertyValues));
  }
